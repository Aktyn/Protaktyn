...
class Label(Widget):
    ...
    def __init__(self, text: str, pos: tuple[int, int], font_size=4, font_thickness=2, text_color=(241, 239, 236),
    ...
    def draw(self, image: np.ndarray):
        ...
        off_x = ((w // 4) if self.__align & GUIConsts.TextAlign.H_CENTER else 0)
        off_y = ((h // 4) if self.__align & GUIConsts.TextAlign.V_CENTER else 0)
